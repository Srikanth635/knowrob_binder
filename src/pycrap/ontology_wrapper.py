...
class OntologyWrapper:
    ...
    def __init__(self):
        self.file = default_pycrap_ontology_file # Temp file
        self.ontology = default_pycrap_ontology  # Loaded ontology from temp file
        self.ontology.name = CRAX_ONTOLOGY_NAME  # PyCRAP
        self.python_objects = {}
    ...
    def reason(self, save_to: str = None):
        """
        ...
        if save_to:
            self.ontology.save(file=save_to, format="rdfxml")
